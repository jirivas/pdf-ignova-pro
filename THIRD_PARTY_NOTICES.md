...
PDF Ignova Pro 1.9.2 uses Open Source components declared in the committed `package.json` / `package-lock.json` source package. Each component retains its own license.
